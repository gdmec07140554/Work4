package s07140554.gdmec.edu.cn.work4;
...
public class ContactsMessageActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // Inflate the menu; this adds items to the action bar if it is present.getMenuInflater().inflate(R.menu.menu_contacts_message, menu);
        return true;
    }
